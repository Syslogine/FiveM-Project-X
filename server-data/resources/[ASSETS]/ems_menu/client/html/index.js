...
$("#buylol").click(function(){
  $("#buylol").hide();
  $("#backlol").hide();
  $.post('https://ems_menu/EMSCar1', JSON.stringify({}));

  $.post('https://ems_menu/NUIFocusOff', JSON.stringify({}));
...
$("#buy2lol").click(function(){
  $("#buy2lol").hide();
  $("#back2lol").hide();
  $.post('https://ems_menu/EMSCar2', JSON.stringify({}));
...
$("#buy3lol").click(function(){
  $("#buy3lol").hide();
  $("#back3lol").hide();
  $.post('https://ems_menu/EMSCar3', JSON.stringify({}));
...
$("#buy4lol").click(function(){
  $("#buy4lol").hide();
  $("#back4lol").hide();
  $.post('https://ems_menu/EMSCar4', JSON.stringify({}));
...
$("#buy5lol").click(function(){
  $("#buy5lol").hide();
  $("#back5lol").hide();
  $.post('https://ems_menu/EMSCar5', JSON.stringify({}));
...
$("#buy6lol").click(function(){
  $("#buy6lol").hide();
  $("#back6lol").hide();
  $.post('https://ems_menu/EMSCar6', JSON.stringify({}));
...
$("#buy7lol").click(function(){
  $("#buy7lol").hide();
  $("#back7lol").hide();
  $.post('https://ems_menu/EMSCar7', JSON.stringify({}));
...
$("#buy8lol").click(function(){
  $("#buy8lol").hide();
  $("#back8lol").hide();
  $.post('https://ems_menu/EMSCar8', JSON.stringify({}));
