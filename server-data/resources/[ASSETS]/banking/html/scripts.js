...
$(document).ready(function() {
    ...
    function addlog(amount, message, withdraw, bussiness) {
        ...
        if (withdraw) {
            if (bussiness) {
                $(".transactionhistory").prepend(`<div class="box"><br><a class="textabc" style="font-size: 18px;">Business Account</a><hr style="width: 900px;margin-left: 17px;height: 0px;background-color:rgba(198,198,198,1.0);margin-top: 8px;"><div class="text" style="margin-left: 18px;margin-top: 2px;font-size: 35px;color:#fff;">` + `-` + `$` + amount + `</div><div class="text" style="margin-left: 20px;margin-top:50px;font-size: 15px;margin-bottom: 5px;color: rgba(198,198,198,0.5);;">Message</div><a class="textabc" style="font-size: 18px;margin-left: 20px;color: rgba(198,198,198,0.5);;">` + message + `</a><hr style="width: 900px;margin-left: 19px;height: 0px;border: none;border-top: 1px dotted  rgba(198,198,198,0.5);margin-top: 3px;height: -1px;"></div><br>`)
            } else {
                $(".transactionhistory").prepend(`<div class="box" style="padding:5px;"><br><a class="textabc" style="font-size: 18px;">Personal Account</a><hr style="width: 900px;margin-left: 17px;height: 0px;background-color:rgba(198,198,198,1.0);margin-top: 8px;"><div class="text" style="margin-left: 18px;margin-top: 2px;font-size: 35px;color:#fff;">` + `-` + `$` + amount + `</div><div class="text" style="margin-left: 20px;margin-top:50px;font-size: 15px;margin-bottom: 5px;color: rgba(198,198,198,0.5);;">Message</div><a class="textabc" style="font-size: 18px;margin-left: 20px;color: rgba(198,198,198,0.5);;">` + message + `</a><hr style="width: 900px;margin-left: 19px;height: 0px;border: none;border-top: 1px dotted  rgba(198,198,198,0.5);margin-top: 3px;height: -1px;"></div><br>`)
            }
        } else {
            if (bussiness) {
                $(".transactionhistory").prepend(`<div class="box" style="padding:5px;"><br><a class="textabc" style="font-size: 18px;">Business Account</a><hr style="width: 900px;margin-left: 17px;height: 0px;background-color:rgba(198,198,198,1.0);margin-top: 8px;"><div class="text" style="margin-left: 18px;margin-top: 2px;font-size: 35px;color:#fff">` + `$` + amount + `</div><div class="text" style="margin-left: 20px;margin-top:50px;font-size: 15px;margin-bottom: 5px;color: rgba(198,198,198,0.5);;">Message</div><a class="textabc" style="font-size: 18px;margin-left: 20px;color: rgba(198,198,198,0.5);;">` + message + `</a><hr style="width: 900px;margin-left: 19px;height: 0px;border: none;border-top: 1px dotted  rgba(198,198,198,0.5);margin-top: 3px;height: -1px;"></div><br>`)
