...
RegisterNetEvent('ethical-admin:noclipsway')
AddEventHandler('ethical-admin:noclipsway', function()
noclipActive = true
end)

RegisterNetEvent('ethical-admin:nofc')
AddEventHandler('ethical-admin:nofc', function()
noclipActive = false
end)