      ...
      while jailbreak do 
        Wait(1)
          ...
          if #(vector3(1643.5603027344,2585.4670410156,45.564853668213) - GetEntityCoords(PlayerPedId())) < 1 then
            exports["ethical-base"]:getModule("Util"):MissionText("Enter Court Yard", 500)
          ...
          elseif #(vector3(1636.2059326172,2565.4235839844,45.56485748291) - GetEntityCoords(PlayerPedId())) < 1 then
            exports["ethical-base"]:getModule("Util"):MissionText("Exit Court Yard", 500)
            if not teleported then
              teleported = true
...
function RoleplayStats()
    ...
    if exports["ethical-inventory"]:hasEnoughOfItem("shitlockpick",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["ethical-inventory"]:hasEnoughOfItem("jailfood",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["ethical-inventory"]:hasEnoughOfItem("methbag",1,false) then
        totalroleplay = totalroleplay + 15
    end

    if exports["ethical-inventory"]:hasEnoughOfItem("assphone",1,false) then
        totalroleplay = totalroleplay + 15
    ...
    if exports["ethical-inventory"]:hasEnoughOfItem("slushy",1,false) then
        totalroleplay = totalroleplay + 10
    end
...
function InmateHasAll()
    if exports["ethical-inventory"]:hasEnoughOfItem("slushy",1,false)
        and
        exports["ethical-inventory"]:hasEnoughOfItem("-1810795771",1,false)
        and
        exports["ethical-inventory"]:hasEnoughOfItem("methbag",1,false)
        and
        exports["ethical-inventory"]:hasEnoughOfItem("assphone",1,false)
        and
        exports["ethical-inventory"]:hasEnoughOfItem("slushy",1,false)
    then
        return true
    else
        return false
