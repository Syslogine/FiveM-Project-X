        ...
        if v[3] == buttonName then
            if v[4] ~= "normal" and v[4] ~= "dead" and imdead == 0 then
                ...
                elseif v[4] == "handcuffer" then
                    if exports["ethical-inventory"]:hasEnoughOfItem("cuffs",1,false) then
                        FeedGui(v[1],v[2],v[4])
                    end
                ...
                elseif v[4] == "DA" and exports["ethical-base"]:getModule("LocalPlayer"):getVar("job") == "district attorney" then
                    FeedGui(v[1],v[2],v[4])
                elseif v[4] == "buy" then
