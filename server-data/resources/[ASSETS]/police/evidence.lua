...
RegisterNetEvent("ethical-admin:ReviveInDistance2")
AddEventHandler("ethical-admin:ReviveInDistance2", function()
    local playerList = {}
...
function findBed(fadein)
	...
	if not inbed then
		...
		TriggerEvent("ethical-admin:ReviveInDistance2")
		TriggerEvent('ethical-hospital:client:FinishServices')
