...
--     exports.ethical_discord_api:<function>
--
-- For example:
--		exports.ethical_discord_api:GetRoleIdFromRoleName("roleName")
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] The roleID for (" .. roleName .. ") is: " .. tostring(roleID));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Player " .. GetPlayerName(user) .. " has Discord email verified?: " .. tostring(isVerified));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Player " .. GetPlayerName(user) .. " has Discord email address: " .. tostring(emailAddr));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Player " .. GetPlayerName(user) .. " has Discord name: " .. tostring(name));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild icon URL is: " .. tostring(icon_URL));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild splash URL is: " .. tostring(splash_URL));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild name is: " .. tostring(guildName));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild description is: " .. tostring(guildDesc));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild member count is: " .. tostring(guildMemCount));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Guild online member count is: " .. tostring(onlineMemCount));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Player " .. GetPlayerName(user) .. " has Discord avatar: " .. tostring(avatar));
...
-- Usage:
	...
	print("[ETHICAL_Perms Example] Player " .. GetPlayerName(user) .. " has Discord nickname: " .. tostring(nickname));
