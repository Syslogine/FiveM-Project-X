...
PXXY.RegisterServerCallback = function(eventName, callback)
    serverCallbacks[eventName] = callback
end

RegisterNetEvent("pxxy:triggerServerCallback", function(eventName, requestId, invoker, ...)
    ...
    serverCallbacks[eventName](source, function(...)
        TriggerClientEvent("pxxy:serverCallback", source, requestId, invoker, ...)
    end, ...)
end)
...
---@param callback function
---@param ... any
PXXY.TriggerClientCallback = function(player, eventName, callback, ...)
    clientRequests[RequestId] = callback

    TriggerClientEvent("pxxy:triggerClientCallback", player, eventName, RequestId, GetInvokingResource() or "unknown", ...)

    RequestId = RequestId + 1
end

RegisterNetEvent("pxxy:clientCallback", function(requestId, invoker, ...)
