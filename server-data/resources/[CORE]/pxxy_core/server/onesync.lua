...
function PXXY.OneSync.GetPlayersInArea(source, maxDistance, ignore)
...
---@param maxDistance number
---@param ignore? table playerIds to ignore, where the key is playerId and value is true
function PXXY.OneSync.GetClosestPlayer(source, maxDistance, ignore)
...
---@param cb function
function PXXY.OneSync.SpawnVehicle(model, coords, heading, properties, cb)
    local vehicleModel = joaat(model)
    local vehicleProperties = properties

    CreateThread(function()
        local xPlayer = PXXY.OneSync.GetClosestPlayer(coords, 300)
        PXXY.GetVehicleType(vehicleModel, xPlayer.id, function(vehicleType)
            if vehicleType then
...
---@param heading number
---@param cb function
function PXXY.OneSync.SpawnObject(model, coords, heading, cb)
...
---@param heading number
---@param cb function
function PXXY.OneSync.SpawnPed(model, coords, heading, cb)
    if type(model) == "string" then
        model = joaat(model)
    end
    CreateThread(function()
...
---@param seat number
---@param cb function
function PXXY.OneSync.SpawnPedInVehicle(model, vehicle, seat, cb)
    if type(model) == "string" then
        model = joaat(model)
    end
    CreateThread(function()
...
---@return table
function PXXY.OneSync.GetPedsInArea(coords, maxDistance, modelFilter)
...
---@param modelFilter table models to ignore, where the key is the model hash and the value is true
---@return table
function PXXY.OneSync.GetObjectsInArea(coords, maxDistance, modelFilter)
...
---@param modelFilter table models to ignore, where the key is the model hash and the value is true
---@return table
function PXXY.OneSync.GetVehiclesInArea(coords, maxDistance, modelFilter)
...
function PXXY.OneSync.GetClosestPed(coords, modelFilter)
...
---@param modelFilter table models to ignore, where the key is the model hash and the value is true
---@return number entityId, number distance, vector3 coords
function PXXY.OneSync.GetClosestObject(coords, modelFilter)
...
---@param modelFilter table models to ignore, where the key is the model hash and the value is true
---@return number entityId, number distance, vector3 coords
function PXXY.OneSync.GetClosestVehicle(coords, modelFilter)
