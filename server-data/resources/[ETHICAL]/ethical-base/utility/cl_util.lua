function ETHICAL.Util.MissionText(self, text, time)
...
function ETHICAL.Util.DrawText(self, text, font, centre, x, y, scale, r, g, b, a)
    SetTextFont(font)
    SetTextProportional(0)
    SetTextScale(scale, scale)
    SetTextColour(r, g, b, a)
...
function ETHICAL.Util.DrawText3D(self, x,y,z, text)
...
function ETHICAL.Util.RotationToDirection(self,rotation)
...
function ETHICAL.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = ETHICAL.Util.RotationToDirection(self,camRot);
      ...
      local camRight = ETHICAL.Util.RotationToDirection(self,rotRight) - ETHICAL.Util.RotationToDirection(self,rotLeft);
      local camUp = ETHICAL.Util.RotationToDirection(self,rotUp) - ETHICAL.Util.RotationToDirection(self,rotDown);
