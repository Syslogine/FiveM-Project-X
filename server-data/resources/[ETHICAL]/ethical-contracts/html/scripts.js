$(document).ready(function(){
  ...
  $(".btnPrev").click(function(){
      $.post('http://ethical-contracts/previousID', JSON.stringify({}));
  });

  $(".btnNext").click(function(){
      $.post('http://ethical-contracts/nextID', JSON.stringify({}));
  });

  $(".btnPay").click(function(){
      $.post('http://ethical-contracts/payID', JSON.stringify({}));
  });

  $(".btnGive").click(function(){
      $.post('http://ethical-contracts/giveID', JSON.stringify({ target: $("#contractID2").val(), conamount: $("#contractAmount2").val(), coninformation: $("#contractInfo2").val()}));
  });
  ...
  document.onkeyup = function (data) {
    if ( data.which == 27 ) {
      $.post('http://ethical-contracts/close', JSON.stringify({}));
    }
    if ( data.which == 37 ) {
      $.post('http://ethical-contracts/previousID', JSON.stringify({}));
    }
