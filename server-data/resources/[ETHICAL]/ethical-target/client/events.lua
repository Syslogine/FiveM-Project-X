...
Citizen.CreateThread(
    function()
        ...
        -------- Hotel --------
        AddBoxZone("hotel_entermenu", vector3(-1448.13, -536.7, 34.74), 2.4, 3, {
        ...
        AddTargetModel(change,
        {
            options = {
                {
                    event = "hotel:outfitmenu",
                    icon = "fas fa-tshirt",
    ...
    AddBoxZone("BurgerShot_trade_receipts", vector3(-1192.01, -900.95, 14.0), 1.6, 1, {
        ...
        AddBoxZone("hospitalgarage1", vector3(340.69, -586.61, 28.8), 0.6, 3, {
            name="hospitalgarage1",
            heading=338,
            --debugPoly=true,
            minZ=28.8,
            maxZ=29.4
            ...
            options = {
                {
                    event = "ethical-hospital:elevatorgarage",
                    icon = "fas fa-building",
        ...
        AddBoxZone("hospitalgarage2", vector3(340.89, -582.45, 28.8), 0.4, 0.4, {
            name="hospitalgarage2",
            heading=340,
            --debugPoly=true,
            minZ=28.8,
            maxZ=29.4
        ...
        AddBoxZone("hospitalroof1", vector3(332.35, -597.32, 43.28), 0.2, 1, {
            ...
            options = {
                {
                    event = "ethical-hospital:elevatormainfloor",
                    icon = "fas fa-building",
                    label = "Enter the Elevator"
                },
            },
        ...
        AddBoxZone("hospitalrooftomain", vector3(338.23, -583.74, 74.16), 3.0, 1, {
            ...
            options = {
                {
                    event = "ethical-hospital:elevatorroof",
                    icon = "fas fa-building",
                    label = "Enter the Door to Elevator."
                }
            },
            job = {"all"},
            distance = 5.0
        ...
        AddBoxZone("hospitaldownele1", vector3(344.89, -584.78, 28.8), 0.4, 0.8, {
            name="hospitaldownele1",
            heading=340,
            --debugPoly=true,
            minZ=28.8,
            maxZ=29.4
        ...
        AddBoxZone("hospitaldownele2", vector3(346.4, -581.17, 28.8), 0.4, 0.8, {
            name="hospitaldownele2",
            heading=340,
            --debugPoly=true,
            minZ=28.8,
            maxZ=29.4
