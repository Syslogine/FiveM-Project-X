function buildCommands(job,src)
    ...
    local commandExport = exports["ethical-base"]:getModule("Commands")
    exports["ethical-base"]:getModule("Player"):GetUser(Lsrc)
...
RegisterServerEvent("ethical-commands:buildCommands")
AddEventHandler("ethical-commands:buildCommands", buildCommands)
...
AddEventHandler("ethical-jobmanager:playerBecameJob", function(src, job)
