RegisterNetEvent('ethical-stash:fetchInitialState')
AddEventHandler('ethical-stash:fetchInitialState', function()
	local source = source
	  TriggerClientEvent('ethical-stash:setInitialState', source, Config.Stash)
end)
