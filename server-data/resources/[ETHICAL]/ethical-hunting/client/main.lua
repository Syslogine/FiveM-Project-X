...
RegisterNetEvent("ethical-hunting:start")
AddEventHandler("ethical-hunting:start", function()
	TriggerServerEvent('ethical-hunting:starthoe')
end)

RegisterNetEvent("ethical-hunting:start2")
AddEventHandler("ethical-hunting:start2", function()
	StartHuntingSession()
end)

RegisterNetEvent("ethical-hunting:stop")
AddEventHandler("ethical-hunting:stop", function()
	if OnGoingHuntSession then
		TriggerEvent('hunting:onxhair', true)
		if exports["ethical-inventory"]:getQuantity(100416529) then
			OnGoingHuntSession = false
			TriggerServerEvent('ethical-hunting:removeloadout')
			TriggerServerEvent('lrp:huntingreturnree')
...
RegisterNetEvent("ethical-hunting:sellcarcass1")
AddEventHandler("ethical-hunting:sellcarcass1", function()
	if exports["ethical-inventory"]:getQuantity("huntingcarcass1") >= 1 then
		playerAnim()
		local finished = exports["ethical-taskbar"]:taskBar(4000,"Selling 1 Star",true,false,playerVeh)
		if finished == 100 then
			ClearPedTasksImmediately(PlayerPedId())
			TriggerEvent('inventory:removeItem', 'huntingcarcass1', 1)
			TriggerServerEvent("server:givepayJob", "Hunting", math.random(80, 100))
		end
	else
...
RegisterNetEvent("ethical-hunting:sellcarcass2")
AddEventHandler("ethical-hunting:sellcarcass2", function()
	if exports["ethical-inventory"]:getQuantity("huntingcarcass2") >= 1 then
		playerAnim()
		local finished = exports["ethical-taskbar"]:taskBar(4000,"Selling 2 Star",true,false,playerVeh)
		if finished == 100 then
			ClearPedTasksImmediately(PlayerPedId())
			TriggerEvent('inventory:removeItem', 'huntingcarcass2', 1)
			TriggerServerEvent("server:givepayJob", "Hunting", math.random(100, 110))
		end
	else
...
RegisterNetEvent("ethical-hunting:sellcarcass3")
AddEventHandler("ethical-hunting:sellcarcass3", function()
	if exports["ethical-inventory"]:getQuantity("huntingcarcass3") >= 1 then
		playerAnim()
		local finished = exports["ethical-taskbar"]:taskBar(4000,"Selling 3 Star",true,false,playerVeh)
		if finished == 100 then
			ClearPedTasksImmediately(PlayerPedId())
			TriggerEvent('inventory:removeItem', 'huntingcarcass3', 1)
			TriggerServerEvent("server:givepayJob", "Hunting", math.random(200, 350))
		end
	else
...
RegisterNetEvent("ethical-hunting:sellcarcass4")
AddEventHandler("ethical-hunting:sellcarcass4", function()
	if exports["ethical-inventory"]:getQuantity("huntingcarcass4") >= 1 then
		playerAnim()
		local finished = exports["ethical-taskbar"]:taskBar(4000,"Selling Red 3 Star",true,false,playerVeh)
		if finished == 100 then
			ClearPedTasksImmediately(PlayerPedId())
...
function StartHuntingSession()
	if canHunt == true then
		if not OnGoingHuntSession then
				...
				TriggerServerEvent('ethical-hunting:giveloadout')
									...
									if IsControlJustReleased(0, Keys['E']) then
										if GetSelectedPedWeapon(PlayerPedId()) == GetHashKey('WEAPON_KNIFE')  then
											if DoesEntityExist(value.id) then
												...
												local finished = exports["ethical-taskbar"]:taskBar(10000,"Skinning")
												TaskPlayAnim(PlayerPedId(), "amb@medic@standing@kneel@base" ,"base" ,8.0, -8.0, -1, 1, 0, false, false, false )
												TaskPlayAnim(PlayerPedId(), "anim@gangops@facility@servers@bodysearch@" ,"player_search" ,8.0, -8.0, -1, 48, 0, false, false, false )
													if finished == 100 then
