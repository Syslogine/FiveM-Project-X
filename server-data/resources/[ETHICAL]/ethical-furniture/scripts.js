$(document).ready(function(){
  ...
  $(".btnClose").click(function(){
      closeMain()
      $.post('http://ethical-furniture/close', JSON.stringify({}));
  });
  ...
  $(".btnMove").click(function(){
      ...
      $(".SelectObject").css("display", "none");
      $.post('http://ethical-furniture/scanObject', JSON.stringify({}));
  });

  $(".btnFree").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://ethical-furniture/FreeCam', JSON.stringify({}));
  });
  ...
  $(".btnModify").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://ethical-furniture/newObject', JSON.stringify({}));
  ...
  $(".btnDelObj").click(function(){
    $.post('http://ethical-furniture/DelSelectedObj', JSON.stringify({}));
  });
  ...
  $(".btnDel").click(function(){
      ...
      $.post('http://ethical-furniture/DelObj', JSON.stringify({}));
  });

  $(".btnNextObj").click(function(){
    $.post('http://ethical-furniture/NextObj', JSON.stringify({}));
  });
  $(".btnPrevObj").click(function(){
    $.post('http://ethical-furniture/PrevObj', JSON.stringify({}));
  });
    ...
    if(item.redoCSS === true) {
      $('select').each(function(){
          ...
          $listItems.click(function(e) {
              ...
              $.post('http://ethical-furniture/selectObject', JSON.stringify({selectObject: $this.val()}));
          });
