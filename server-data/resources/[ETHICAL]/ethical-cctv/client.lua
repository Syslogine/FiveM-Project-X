...
Citizen.CreateThread(function ()
	while true do
		...
		if inCam then
			...
			if IsControlPressed(1, 108) or IsControlPressed(1, 174) then
				SetCamRot(cctvCam, rota.x, 0.0, rota.z + 0.7, 2)
			end

			if IsControlPressed(1, 107) or IsControlPressed(1, 175) then
				SetCamRot(cctvCam, rota.x, 0.0, rota.z - 0.7, 2)
			end

			if IsControlPressed(1, 61) or IsControlPressed(1, 172) then
				SetCamRot(cctvCam, rota.x + 0.7, 0.0, rota.z, 2)
			end

			if IsControlPressed(1, 60) or IsControlPressed(1, 173) then
				SetCamRot(cctvCam, rota.x - 0.7, 0.0, rota.z, 2)
			end
		end
	end
