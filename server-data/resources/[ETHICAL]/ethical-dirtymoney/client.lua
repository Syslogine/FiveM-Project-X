...
RegisterNetEvent("ethical-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("ethical-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("ethical-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("ethical-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('ethical-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("ethical-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("ethical-dirtymoney:alterDirtyMoney","ItemDrop",amount)
