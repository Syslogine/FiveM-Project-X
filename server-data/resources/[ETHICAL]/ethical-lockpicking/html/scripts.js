...
function outOfPins() {
  $.post('http://ethical-lockpicking/failure', JSON.stringify({}));
  gameOver = true;
...
function unlock() {
  $.post('http://ethical-lockpicking/complete', JSON.stringify({}));
...
document.onkeyup = function (data) {
  if (data.which == 27 ) {
    $.post('http://ethical-lockpicking/close', JSON.stringify({}));
  }
};
