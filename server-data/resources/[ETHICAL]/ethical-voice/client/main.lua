...
AddEventHandler('ethical-voice:settingsCallback', function(cb)
	cb(Cfg)
end)

RegisterNetEvent('ethical-voice:SetRadioVolume')
AddEventHandler('ethical-voice:SetRadioVolume', function(passedRadioVolume)
	volume = passedRadioVolume
end)

RegisterNetEvent('ethical-voice:updateRoutingBucket')
AddEventHandler('ethical-voice:updateRoutingBucket', function(routingBucket)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('ethical-voice:setTalkingMode', voiceMode)
	TriggerEvent("ethical-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('ethical-voice:mutePlayer')
AddEventHandler('ethical-voice:mutePlayer', function()
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('ethical-voice_enableMicClicks', val)
	end
end
...
RegisterCommand('vsync', function()
	local newGrid = getGridZone()
	debug(('[ethical-voice] [vsync] Forcing zone from %s to %s and adding nearby grids.'):format(currentGrid, newGrid))
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('ethical-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('ethical-voice_enableMicClicks', tostring(true))
	else
	...
	print('[ethical-voice] Intitalized voices.')
	intialized = true
...
RegisterCommand("grid", function()
	print(('[ethical-voice] Players current grid is %s'):format(currentGrid))
end)