...
RegisterNetEvent('ethical-voice:syncRadioData', syncRadioData)
...
RegisterNetEvent('ethical-voice:setTalkingOnRadio', setTalkingOnRadio)
...
RegisterNetEvent('ethical-voice:addPlayerToRadio', addPlayerToRadio)
...
RegisterNetEvent('ethical-voice:removePlayerFromRadio', removePlayerFromRadio)
...
function setRadioChannel(channel)
	...
	TriggerServerEvent('ethical-voice:setPlayerRadio', channel)
...
RegisterCommand('+radiotalk', function()
    ...
    if not voiceData.radioPressed and voiceData.radioEnabled then
        if voiceData.radio > 0 then
            TriggerServerEvent('ethical-voice:setTalkingOnRadio', true)
            voiceData.radioPressed = true
			playMicClicks(true)
            Citizen.CreateThread(function()
                TriggerEvent("ethical-voice:radioActive", true)
...
RegisterCommand('-radiotalk', function()
	if voiceData.radio > 0 or voiceData.radioEnabled then
		...
		TriggerEvent("ethical-voice:radioActive", false)
		playMicClicks(false)
		TriggerServerEvent('ethical-voice:setTalkingOnRadio', false)
...
RegisterNetEvent('ethical-voice:clSetPlayerRadio', syncRadio)
