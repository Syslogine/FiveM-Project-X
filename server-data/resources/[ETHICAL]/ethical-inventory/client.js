...
RegisterNetEvent('ethical-base:playerSpawned')
on('ethical-base:playerSpawned', (broughtData) => {
...
RegisterNetEvent('ethical-base:update:settings')
on('ethical-base:update:settings', (data) => {
...
on('__cfx_nui:UpdateSettings', (data, cb) => {
	...
	emitNet("ethical-inventory:update:settings", data)
});
