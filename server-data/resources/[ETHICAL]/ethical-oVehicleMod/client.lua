...
function preventVehicleExit()
    Citizen.CreateThread(function()
        ...
        disableControl = true
        disableTurning()
        local finished = exports["ethical-taskbar"]:taskBar(options[math.random(1,3)],"Taking off Harness",true)
...
function toggleHarness()
    ...
    local finished = 0
    if harness then
        finished = exports["ethical-taskbar"]:taskBar(5000,"Taking off Harness",true)
    else
        finished = exports["ethical-taskbar"]:taskBar(5000,"Putting on Harness",true)
    end
    if (finished == 100) then
...
AddEventHandler('nos:help', function()
    ...
    TriggerEvent("chatMessagess", "NOS: ", {255, 255, 255}, "You have %" .. math.floor(NosVehicles[currentVehicle]) .. " left")
end)
