$(document).ready(function () {
  ...
  function closeGui() {
    if (readOnly) {
      // Don't record data
      $.post('http://ethical-driving-instructor/close', JSON.stringify({ cid: -1, points: 10, passed: true, results: {} }));
    } else {
      curTest.results = {};
      ...
      $.post('http://ethical-driving-instructor/close', JSON.stringify({ cid: curTest.cid, points: curTest.points, passed: curTest.passed, results: curTest.results }));
    }
  }
