...
function CheckDamage(ped, bone, weapon)
    ...
    if Config.Bones[bone] ~= nil then
        if not BodyParts[Config.Bones[bone]].isDamaged then
            ...
            TriggerServerEvent('ethical-hospital:server:SyncInjuries', {
                limbs = BodyParts,
...
RegisterNetEvent('ethical-hospital:client:SyncBleed')
AddEventHandler('ethical-hospital:client:SyncBleed', function(bleedStatus)
    isBleeding = tonumber(bleedStatus)
    DoBleedAlert()
end)

RegisterNetEvent('ethical-hospital:client:FieldTreatLimbs')
AddEventHandler('ethical-hospital:client:FieldTreatLimbs', function()
    for k, v in pairs(BodyParts) do
        v.isDamaged = false
        v.severity = 1
    end
...
RegisterNetEvent('ethical-hospital:client:FieldTreatBleed')
AddEventHandler('ethical-hospital:client:FieldTreatBleed', function()
    if isBleeding > 1 then
...
RegisterNetEvent('ethical-hospital:client:ReduceBleed')
AddEventHandler('ethical-hospital:client:ReduceBleed', function()
    if isBleeding > 0 then
        isBleeding = tonumber(isBleeding) - 1
...
RegisterNetEvent('ethical-hospital:client:ResetLimbs')
AddEventHandler('ethical-hospital:client:ResetLimbs', function()
    for k, v in pairs(BodyParts) do
        v.isDamaged = false
        v.severity = 0
    end
...
RegisterNetEvent('ethical-hospital:client:RemoveBleed')
AddEventHandler('ethical-hospital:client:RemoveBleed', function()
    isBleeding = 0
...
RegisterNetEvent('ethical-hospital:client:UsePainKiller')
AddEventHandler('ethical-hospital:client:UsePainKiller', function(tier)
    if tier < 4 then
...
RegisterNetEvent('ethical-hospital:client:UseAdrenaline')
AddEventHandler('ethical-hospital:client:UseAdrenaline', function(tier)
    if tier < 4 then
        onDrugs = 180 * tier
    end
