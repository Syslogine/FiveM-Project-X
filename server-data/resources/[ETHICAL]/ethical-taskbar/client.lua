...
function closeGui()
    ...
    ClearPedTasks(PlayerPedId())
    TriggerEvent("ethical-taskbar:disablecontrols", false)
end
...
function taskBar(length,name,runCheck,keepWeapon,vehicle,vehCheck)
    ...
    TriggerEvent("ethical-taskbar:disablecontrols", true)
...
RegisterNetEvent('ethical-taskbar:disablecontrols')
AddEventHandler('ethical-taskbar:disablecontrols', function(status)
    pDisabled = status
