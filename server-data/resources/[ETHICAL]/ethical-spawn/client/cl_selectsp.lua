Spawn.defaultSpawns = {
	...
	[8] = { ["pos"] = vector4(-1441.61, -546.83, 34.74, 31.12), ['info'] = ' Del Perro Apartments'},
}
...
AddEventHandler('spawn:clientSpawnData', function(spawnData)
		...
		-- 	Spawn.housingCoords = exports["ethical-housing"]:retriveHousingTable();
		-- end
...
function Spawn.selectedSpawn(spawnInfo)
	...
	if apartment then
		...
		if pos then
			...
			DoScreenFadeIn(2500)
			TriggerEvent("ethical-spawn:characterSpawned")
		else 
