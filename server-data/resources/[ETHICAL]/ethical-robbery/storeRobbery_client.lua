...
-- RegisterNetEvent('ethical-numbers:setjobs')
-- AddEventHandler('ethical-numbers:setjobs', function(jobslist)
--   JobCount = jobslist
...
AddEventHandler("robbery:register", function()
	...
	TriggerEvent("player:receiveItem","rollcash",math.random(3, 10))
...
AddEventHandler("robbery:safe", function()
	...
	TriggerEvent("player:receiveItem","rollcash",math.random(10, 25))
	TriggerEvent('inventory:removeItem',"advlockpick", 1)
end)
