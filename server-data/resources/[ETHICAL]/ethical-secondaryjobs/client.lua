...
function hasDecryptGod()
    if exports["ethical-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
AddEventHandler('stringGangGlobalReputations', function()
    ...
    local currenttax = exports["ethical-votesystem"]:getTax()
...
function getQuantitys()
    local weed = exports["ethical-inventory"]:getQuantity("weedoz")
    local cocaine = exports["ethical-inventory"]:getQuantity("coke5g")
    local guns = exports["ethical-inventory"]:getQuantity("riflebody")
    local launder = exports["ethical-inventory"]:getQuantity("inkset")
    local stolengoods = exports["ethical-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["ethical-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["ethical-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["ethical-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
    ...
    while timer > 0 do
        ...
        if not searching then
            ...
            if IsControlJustReleased(1,Controlkey["generalUse"][1]) then
                ...
                local finished = exports["ethical-taskbar"]:taskBar(25000,"Searching Thug")
...
function getQuantitysH()
    local weed = exports["ethical-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["ethical-inventory"]:getQuantity("coke50g")
    local guns = exports["ethical-inventory"]:getQuantity("riflebodybox")
    local launder = exports["ethical-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["ethical-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["ethical-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["ethical-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["ethical-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["ethical-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)
