...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("ethical-bennys:attemptPurchase",cheap, type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("ethical-bennys:purchaseSuccessful")
AddEventHandler("ethical-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
end)

RegisterNetEvent("ethical-bennys:purchaseFailed")
AddEventHandler("ethical-bennys:purchaseFailed", function()
