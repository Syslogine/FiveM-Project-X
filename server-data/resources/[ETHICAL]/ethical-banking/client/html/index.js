$(function() {
  window.addEventListener('message', function(event) {
    if (event.data.type === "openGeneral"){
      ...
      $('body').removeClass("active");
      $.post('http://ethical-banking/NUIFocusOff', JSON.stringify({}));
...
$('.backatm').click(function(){
        $("#loginin, #createaccount, #logininatm, #makejob").hide();
        $.post('https://ethical-banking/NUIFocusOff', JSON.stringify({}));
   })
...
$("#createac").click(function(){
  $('#log').hide();
  $.post('https://ethical-banking/getname', JSON.stringify({}))
...
$("#login1").submit(function(e){
  e.preventDefault();
  $.post('https://ethical-banking/login', JSON.stringify({
    login: $("#login").val(),
...
$("#loginatmok").submit(function(e){
  e.preventDefault();
  $.post('https://ethical-banking/loginatm', JSON.stringify({
    login: $("#loginatm").val(),
...
$("#ohh").submit(function(e){
  e.preventDefault();
  $.post('https://ethical-banking/loginbus', JSON.stringify({
    login: $("#login2").val(),
...
$("#create1").submit(function(e){
  e.preventDefault();
  $.post('https://ethical-banking/createaccountnew', JSON.stringify({
    login12: $("#login12").val(),
  ...
  $.post('https://ethical-banking/NUIFocusOff', JSON.stringify({}));
    ...
    $("#deposit1").submit(function(e) {
      e.preventDefault();
      $.post('https://ethical-banking/deposit', JSON.stringify({
          amount: $("#amount").val()
      }));
...
$("#transfer1").submit(function(e) {
      e.preventDefault();
      $.post('https://ethical-banking/transfer', JSON.stringify({
    to: $("#to").val(),
          amountt: $("#amountt").val()
      }));
  $("#amountt").val('');
...
$("#withdraw1").submit(function(e) {
  e.preventDefault();
      $.post('https://ethical-banking/withdrawl', JSON.stringify({
          amountw: $("#amountw").val()
      }));
  $("#amountw").val('');
});
...
$("#withdraw1atm").submit(function(e) {
  e.preventDefault();
      $.post('https://ethical-banking/withdrawlatm', JSON.stringify({
