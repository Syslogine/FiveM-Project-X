...
AddEventHandler('weed:currentStatus', function(weed_level,weed_percent,weed_status,weed_amount)
    TriggerEvent("chatMessagess", "TASK ", { 195, 255, 255 }, "Current Batch: " .. weed_percent .. "% | Crates Available: " .. weed_amount)
end)
...
AddEventHandler('gunrunner:currentStatus', function(gunrunner_level,gunrunner_percent,gunrunner_status,gunrunner_amount)
    ...
    TriggerEvent("chatMessagess", "TASK ", { 195, 255, 255 }, "Current Batch: " .. gunrunner_percent .. "% | Crates Available: " .. gunrunner_amount)
end)
...
AddEventHandler('launder:currentStatus', function(launder_level,launder_percent,launder_status,launder_amount)
    ...
    TriggerEvent("chatMessagess", "TASK ", { 195, 255, 255 }, "Current Batch: " .. launder_percent .. "% | Crates Available: " .. launder_amount)
end)
...
AddEventHandler('cocaine:currentStatus', function(cocaine_level,cocaine_percent,cocaine_status,cocaine_amount)
    ...
    TriggerEvent("chatMessagess", "TASK ", { 195, 255, 255 }, "Current Batch: " .. cocaine_percent .. "% | Crates Available: " .. cocaine_amount)
end)
