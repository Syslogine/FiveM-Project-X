...
RegisterNetEvent('ethical-dispatch:bankrobbery2')
AddEventHandler('ethical-dispatch:bankrobbery2', function()
    BankingShit()
end)

function BankingShit()
  local street1 = GetStreetAndZone()
  local plyPos = GetEntityCoords(PlayerPedId(), true)
  if checkedLocations() then
    return
...
function AlertDeath()
  ...
  TriggerEvent('ethical-dispatch:downguy')
end
...
RegisterNetEvent('ethical-dispatch:storerobbery2')
AddEventHandler('ethical-dispatch:storerobbery2', function()
    AlertpersonRobbed()
end)
...
--   TriggerEvent("jew:rob")

-- end)

RegisterNetEvent("jew:rob")
AddEventHandler("jew:rob" ,function()
  AlertJew()
end)
...
function AlertJew()
  ...
  TriggerEvent('ethical-dispatch:robstore')
  Wait(math.random(5000,15000))
...
RegisterNetEvent('ethical-dispatch:houserobbery')
AddEventHandler('ethical-dispatch:houserobbery', function()
    AlertCheckRobbery2()
end)
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('ethical-dispatch:robhouse')
  Wait(math.random(5000,15000))
...
RegisterNetEvent('ethical-dispatch:banktruck2')
AddEventHandler('ethical-dispatch:banktruck2', function()
    AlertBankTruck()
end)


RegisterNetEvent('ethical-dispatch:panic')
AddEventHandler('ethical-dispatch:panic', function()
    AlertPanic()
end)
...
function AlertPanic()
  ...
  TriggerServerEvent('dispatch:svNotify', {
    ...
    isImportant = true,
    priority = 1,
    dispatchMessage = "10-78 Panic Button Pressed",
    recipientList = {
      police = "police",
      ems = "ems"
    },
  ...
  TriggerEvent('ethical-dispatch:bankt')
...
function AlertGunShot()
  Citizen.CreateThread(function() 
    ...
    TriggerEvent('ethical-dispatch:gunshotcl')
...
RegisterNetEvent('ethical-dispatch:stealvehiclehoe')
AddEventHandler('ethical-dispatch:stealvehiclehoe', function()
    AlertCheckLockpick()
end)
...
function AlertCheckLockpick()
  Citizen.CreateThread(function() 
    ...
    TriggerEvent('ethical-dispatch:stolenveh')
    Wait(math.random(5000,10000))
    ...
    if math.random(1,10) > 3 and IsPedInAnyVehicle(PlayerPedId()) and not isInVehicle then
      ...
      TriggerServerEvent('dispatch:svNotify', {
        ...
        isImportant = false,
        priority = 1,
        dispatchMessage = " Vehicle Fleeing from scene",
        recipientList = {
          police = "police", ems = "ems"
        },
        origin = {
