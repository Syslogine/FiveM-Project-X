        ...
        if insideDriftSchool then
            ...
            if repairDist[1] < 5 and health < 1000.0 and veh ~= 0 and rank >= 1 then
                ...
                if IsControlJustPressed(1, 38) then
                    TriggerServerEvent("ethical-driftschool:takemoney", repairCost(veh, health))
                    ...
                    if not isPurchaseSuccessful then
                        ...
                        local finished = exports["ethical-taskbar"]:taskBar(15000,"Fixing Vehicle",true)
...
RegisterNetEvent('ethical-driftschool:tookmoney')
AddEventHandler('ethical-driftschool:tookmoney', function(taken)
